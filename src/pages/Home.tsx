    ...
    <div className="min-h-screen">
      ...
      {selectedImg && (
        ...
        >
          ...
          <img 
            src={selectedImg} 
            className="max-w-full max-h-[90vh] object-contain animate-[scaleIn_0.3s_ease-out_forwards]" 
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative z-10 pt-10 lg:pt-0">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-6 lg:gap-8 items-center justify-center lg:justify-start animate-fade-in-up [animation-delay:600ms]">
              ...
              <a href="#hizmetler" className="group flex items-center gap-3 text-xs lg:text-sm font-bold uppercase tracking-widest hover:text-gold transition-all cursor-pointer">
                Hizmetlerimiz
          ...
          <div className="flex-1 relative w-full max-w-[500px] lg:max-w-none">
            <div className="relative z-10 animate-[scaleIn_1.2s_ease-out_forwards]">
              <div className="rounded-t-[120px] lg:rounded-t-[200px] rounded-b-lg overflow-hidden shadow-[20px_20px_0px_-5px_rgba(197,160,89,0.1)] lg:shadow-[40px_40px_0px_-10px_rgba(197,160,89,0.1)] border border-cream-dark">
                <img src="/cilt-bakimi.jpg" alt="Luxury Beauty Treatment" className="w-full h-[400px] lg:h-[650px] object-cover animate-slow-zoom" />
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 auto-rows-[200px] md:auto-rows-[400px]">
            {galleryImages.map((img, idx) => (
              <div 
                ...
                className={`relative group overflow-hidden animate-fade-in-up cursor-pointer ${idx === 0 ? 'md:col-span-2 md:row-span-2' : ''} ${idx === 3 ? 'md:col-span-2' : ''}`}
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <img src={img} className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-110" alt="Galeri" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div 
                key={i} 
                className="bg-cream p-10 border border-gold/10 relative animate-fade-in-up"
      ...
      <section id="hakkimizda" className="py-24 lg:py-40 bg-white overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="flex-1 relative animate-fade-in-left w-full max-w-[600px] lg:max-w-none">
              <div className="relative z-10">
                <div className="rounded-none border-[10px] lg:border-[20px] border-cream overflow-hidden shadow-2xl">
                  <img src="/igneli-epilasyon.jpg" alt="About Parlaten" className="w-full h-[450px] lg:h-[700px] object-cover hover:scale-105 transition-transform duration-1000" />
                </div>
            ...
            <div className="flex-1 animate-fade-in-up text-center lg:text-left pt-10 lg:pt-0">
