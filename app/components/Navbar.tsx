    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-[100] bg-white/95 backdrop-blur-md border-b border-cream-dark transition-all duration-300">
        <div className="container mx-auto px-6 h-20 md:h-24 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-10 text-[11px] font-bold uppercase tracking-[0.2em] text-charcoal-light">
            <Link href="/" className="hover:text-gold transition-colors cursor-pointer">Anasayfa</Link>
            <Link href="/hizmet" className="hover:text-gold transition-colors cursor-pointer">Hizmetlerimiz</Link>
            <Link href="/#hakkimizda" className="hover:text-gold transition-colors cursor-pointer">Hakkımızda</Link>
            <Link href="/iletisim" className="hover:text-gold transition-colors cursor-pointer">İletişim</Link>
          </div>
      ...
      >
        <div className="flex flex-col items-center space-y-6 text-center w-full min-h-fit pb-12">
          <Link href="/" className="text-3xl font-serif text-charcoal hover:text-gold transition-colors">Anasayfa</Link>
          <div className="w-12 h-[1px] bg-gold/30"></div>
          <Link href="/hizmet" className="text-3xl font-serif text-charcoal hover:text-gold transition-colors">Hizmetlerimiz</Link>
          <div className="w-12 h-[1px] bg-gold/30"></div>
          <Link href="/#hakkimizda" className="text-3xl font-serif text-charcoal hover:text-gold transition-colors">Hakkımızda</Link>
          <div className="w-12 h-[1px] bg-gold/30"></div>
          <Link href="/iletisim" className="text-3xl font-serif text-charcoal hover:text-gold transition-colors">İletişim</Link>
